...
|---|---|---|---|---|---|---|
| **Exist.** | 20. Input node x_i | 27. Input pulse arrives | 34. Pre-activation state | 41. Input vector **x** | 48. Forward pass initiates | 55. Target vector **t** |
| **Dist.** | 21. Active/Inactive | 28. Firing/Silence | 35. Threshold θ | 42. Output ≠ Target | 49. Error event | 56. Error magnitude E |
| **Disj.** | 22. Disconnected nodes | 29. Independent pulses | 36. Sub-threshold decay | 43. Orthogonal features | 50. Gradient components | 57. Gradient vector ∇E |
| **Conj.** | 23. Weight w_ij | 30. Weighted sum Σw_i x_i | 37. Threshold exceeded | 44. Weight matrix **W** | 51. Batch accumulation | 58. Loss function ℒ |
| **Trans.** | 24. Hidden node | 31. Signal propagates | 38. Transfer function | 45. Hidden layers | 52. Backpropagation | 59. Chain rule ∂E/∂w |
| **Clos.** | 25. Output node y_j | 32. Final activation | 39. Saturated state | 46. Output vector **y** | 53. Weight update Δw | 60. Loss minimized |
...
| Cat. | Local Structure | Local Process | Local Control | Global Space | Global Time | Global Causality |
|---|---|---|---|---|---|---|
| **Exist.** | 20. **Pixel** p_ij | 27. Patch activation | 34. Pre-activation | 41. **Image tensor** H×W×C | 48. Forward pass | 55. Target label |
| **Dist.** | 21. **Edge/No-edge** | 28. Firing/Silence | 35. Threshold θ | 42. Predicted ≠ Target | 49. Error event | 56. Error magnitude |
...
| **Conj.** | 23. **Kernel** k×k | 30. **Convolution** Σk · p | 37. Threshold exceeded | 44. **Filter bank** | 51. Batch accumulation | 58. Loss function |
...
| **Dist.** | 21. **Present/Past** | 28. Firing/Silence | 35. Threshold | 42. Output ≠ Target | 49. Error event | 56. Error magnitude |
...
| **Recur.** | 26. **h_t → h_{t-1}** | 33. **Next t fires** | 40. **State carry** | 47. Architecture fixed | 54. Next epoch | 61. LR decay |
...
| **Dist.** | 21. **Connected/Not** | 28. Message/No-message | 35. Threshold | 42. Output ≠ Target | 49. Error event | 56. Error magnitude |
| **Disj.** | 22. **N(v) boundary** | 29. **Adjacency filter** | 36. **Degree normalization** | 43. **Adjacency A** | 50. Gradient per node | 57. Gradient vector |
| **Conj.** | 23. **Message function** | 30. **Aggregate Σ_{u ∈ N(v)}** | 37. Integration | 44. **Weight matrix** | 51. Batch accumulation | 58. Loss function |
...
| **Recur.** | 26. h_v^{(k)} → h_v^{(k+1)} | 33. Next round fires | 40. Iterative refine | 47. Architecture fixed | 54. Next epoch | 61. LR decay |
...
| 10 | Conjunction | **Dynamic Attention Scores softmax(QK^T/√d)** | **Changed** |
...
| **Dist.** | 21. **Q, K, V** | 28. Projection event | 35. **Scaling 1/√d** | 42. Output ≠ Target | 49. Error event | 56. Error magnitude |
